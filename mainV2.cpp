...
void renderMoonPlanet1(float x, float y, float z)
{
	...
	//model = glm::rotate(planetAxes1, rotateY2, glm::vec3(0.0f, 1.0f, 0.0f));
...
void initMoonPlanet1(float x, float y, float z)
{
	// set attribute locations (of shader) for GLUT
	GLuint programId = program.getHandle();
	// position attribute to variable "position"
	...
	// Modify model matrix.
	glm::mat4 model(moonPlanet1.model);
...
bool init()
{
	...
	initPlanet2();
	initPlanet1();
	initMoonPlanet1(3.5, 0.0, -0.5);
	//initMoonPlanet1(6.5, 0.0, -0.5);
	//initMoonPlanet1(5.0, 0.0, 1.5);
	initMoonPlanet2();
	initAxesPlanet1();
	initAxesPlanet2();
...
void render()
{
	...
	renderMoonPlanet1(3.5, 0.0, -0.5);
	//renderMoonPlanet1(6.5, 0.0, -0.5);
	//renderMoonPlanet1(5.0, 0.0, 1.5);

	renderPlanet2(-10.0, 0.0, 0.0);
	renderAxesPlanet2(-10.0, 0.0, 0.0);
	renderMoonPlanet2(-10.5, 1.5, -1.0);
	renderMoonPlanet2(-11.5, 1.5, 1.0);
	renderMoonPlanet2(-9.5, 1.5, 1.0);
	renderMoonPlanet2(-8.5, 1.5, -1.0);
