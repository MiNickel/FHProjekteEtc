...
Idx Name          Size      VMA       LMA       File off  Algn
  ...
  4 .ARM.attributes 0000002a  00000000  00000000  00010378  2**0
                  CONTENTS, READONLY
  5 .comment      0000007e  00000000  00000000  000103a2  2**0
                  CONTENTS, READONLY
...
0000029c <main>:
 ...
 2ba:	4b0c      	ldr	r3, [pc, #48]	; (2ec <main+0x50>)
 2bc:	681b      	ldr	r3, [r3, #0]
 2be:	4a0b      	ldr	r2, [pc, #44]	; (2ec <main+0x50>)
 2c0:	f043 0308 	orr.w	r3, r3, #8
 2c4:	6013      	str	r3, [r2, #0]
 2c6:	f7ff ffd1 	bl	26c <delay>
 2ca:	4b08      	ldr	r3, [pc, #32]	; (2ec <main+0x50>)
 2cc:	681b      	ldr	r3, [r3, #0]
 2ce:	4a07      	ldr	r2, [pc, #28]	; (2ec <main+0x50>)
...
000002f0 <ResetISR>:
 ...
 302:	1d13      	adds	r3, r2, #4
 304:	607b      	str	r3, [r7, #4]
 306:	683b      	ldr	r3, [r7, #0]
 308:	1d19      	adds	r1, r3, #4
...
00000320 <zero_loop>:
 ...
 32a:	4b09      	ldr	r3, [pc, #36]	; (350 <zero_loop+0x30>)
 32c:	681b      	ldr	r3, [r3, #0]
 32e:	4a08      	ldr	r2, [pc, #32]	; (350 <zero_loop+0x30>)
