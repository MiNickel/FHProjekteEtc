...
Idx Name          Size      VMA       LMA       File off  Algn
  ...
  4 .ARM.attributes 0000002a  00000000  00000000  0001034c  2**0
                  CONTENTS, READONLY
  5 .comment      0000007e  00000000  00000000  00010376  2**0
                  CONTENTS, READONLY
...
0000026c <main>:
 ...
 276:	2120      	movs	r1, #32
 278:	6011      	str	r1, [r2, #0]
 27a:	6812      	ldr	r2, [r2, #0]
 27c:	601a      	str	r2, [r3, #0]
 27e:	4916      	ldr	r1, [pc, #88]	; (2d8 <main+0x6c>)
 280:	2208      	movs	r2, #8
 ...
 2cc:	4002551c 	.word	0x4002551c
 2d0:	40025400 	.word	0x40025400
...
000002e8 <ResetISR>:
 ...
 2f0:	1d18      	adds	r0, r3, #4
 2f2:	3203      	adds	r2, #3
 2f4:	1a12      	subs	r2, r2, r0
 2f6:	f022 0203 	bic.w	r2, r2, #3
 2fa:	490e      	ldr	r1, [pc, #56]	; (334 <zero_loop+0x22>)
 2fc:	4402      	add	r2, r0
 2fe:	f851 0b04 	ldr.w	r0, [r1], #4
 302:	f843 0b04 	str.w	r0, [r3], #4
 306:	4293      	cmp	r3, r2
