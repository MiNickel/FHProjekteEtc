...
//TODO: tests schreiben fuer die ueberpruefung ob der student in der node geloescht wird
/*
 * Test ob die NULL-Liste geloescht wird
 * @param void
 * @return void
 */
TEST(Studiverwaltung, test_delete_node_null_list) {
 ...
 * @return void
 */
TEST(Studiverwaltung, test_delete_node_only_node) {
    PRINT_INFO("\n");
 ...
 * @return void
 */
TEST(Studiverwaltung, test_delete_node_first_node) {
 ...
 * @return void
 */
TEST(Studiverwaltung, test_delete_node_last_node) {
 ...
 * @return void
 */
TEST(Studiverwaltung, test_delete_node_middle_node) {
...
/*
 * Testet ob und wie oft sp_free aufgerufen wird, wenn eine Liste bestehend
 * aus 3 students und somit 3 nodes mit delete_list() geloescht wird.
 * Am Ende erwarten wir 6 sp_free Aufrufe.
 *
 * @param void
 * @return void
 */
TEST(Studiverwaltung, test_delete_list_cmock) {
    PRINT_INFO("delete_list: Wie oft wird sp_free aufgerufen? CMOCK\n");

FreeMock free_mock;

    EXPECT_FUNCTION_CALL(free_mock, (testing::_))
        .Times(6);
    ...
    studiTest2 = (student*) malloc(sizeof(student));
    CHECK_MALLOC(studiTest2);strcpy(studiTest->name, "Horst");
studiTest2->cps = 42;
studiTest2->enrolled = IFM;
