...
void initCube()
{
	...
	cube_vertices.push_back({ 0,0,0 });
	cube_vertices.push_back({ 1,0,0 });
	cube_vertices.push_back({ 1,1,0 });
	cube_vertices.push_back({ 0,1,0 });
	cube_vertices.push_back({ 0,0,1 });
	cube_vertices.push_back({ 1,0,1 });
	cube_vertices.push_back({ 1,1,1 });
	cube_vertices.push_back({ 0,1,1 });

	cube_colors.push_back({ 1,0,0 });
	...
	glBufferData(GL_ARRAY_BUFFER, cube_vertices.size() * sizeof(glm::vec3), cube_vertices.data(), GL_STATIC_DRAW);
	...
	glBufferData(GL_ARRAY_BUFFER, cube_colors.size() * sizeof(glm::vec3), cube_colors.data(), GL_STATIC_DRAW);
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, cube_indices.size() * sizeof(GLushort), cube_indices.data(), GL_STATIC_DRAW);
